{:name        "Level omega: False Belief Task "
 ...
 :description "Agent a1 puts an object o into b1 in plain view of a2.
               ...
               LevelOmega Belief: a1 believes a2 ..believes a1 believes a2 believes o is in b1.
               "
 ...
 :assumptions {
                ...
                :P1 (Common! t1 (holds (In o b1) t1))
                :P2 (Common! t1 (not (exists [?e] (terminates ?e (In o b1)))))
